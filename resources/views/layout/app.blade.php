...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" href="{{ asset('img/logo/T-Shirt Design 3 (Front).jpg') }}" type="image/png">
  <!-- CSS Custom -->
  @yield('css-custom')
  <!-- Icons -->
  ...
  <nav id="navbar-main" class="navbar navbar-horizontal navbar-brown navbar-main navbar-expand-lg navbar-light">
    <div class="container">
      <a class="navbar-brand" href="{{ route('home')}}">
        <img src="{{ asset('img/logo/Test.png') }}">
      </a>
      ...
      <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
        ...
        <ul class="navbar-nav align-items-lg-center ml-lg-auto">
          ...
          <li class="nav-item">
            <a class="nav-link nav-link-icon" href="https://www.instagram.com/sleight.apparel/" target="_blank" data-toggle="tooltip" data-original-title="Follow us on Instagram">
  ...
  <footer class="py-5 bg-dark-brown" id="footer-main">
    <div class="container">
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
        <img src="{{ asset('img/logo/Untitled-1.png') }}">
        </div>
        <div class="col-xl-6">
          <ul class="nav nav-footer justify-content-center justify-content-xl-end">
            <li class="nav-item">
                <a href="#" class="nav-link text-brown">Sleight</a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link text-brown">About Us</a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link text-brown">Contact Us</a>
              </li>
          </ul>
        </div>
      </div>
